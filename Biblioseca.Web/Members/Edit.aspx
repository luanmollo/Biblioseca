<%@ Page Title="Edit Member" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Biblioseca.Web.Members.Edit" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <br/>
        <asp:Button ID="buttonEditMember" runat="server" Text="Guardar" OnClick="ButtonEditMember_Click" CssClass="btn btn-primary"/>
    </div>
</asp:Content>