<%@ Page Title="Edit Book" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Biblioseca.Web.Books.Edit" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-10">
                <asp:Button ID="buttonEditBook" runat="server" Text="Guardar" OnClick="ButtonEditBook_Click" CssClass="btn btn-default"/>
            </div>
        </div>
    </div>
</asp:Content>